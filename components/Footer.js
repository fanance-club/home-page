						...
						<div className="container">
							<div className="row">
                                ...
                                <div className="footer-widget footer-widget__about">
                                    <img src="/assets/images/resources/logo-v3.png" width="200" alt=""
                            ...
                            <div className="col-lg-6 d-flex justify-content-between footer-widget__links-wrap">
								...
								<div className="col-lg-6">
                                    <h4>Disclaimer</h4>
									<p>
										Fanance Club is neither affiliated by nor associated with
										any private or government sports leagues and tournaments,
										until and unless expressly stated by the Company. In
										addition to this, Fanance club is not related to and does
										not claim any official status with any of the official or
										non-official sports team or sportsperson including but not
										limited to any official governing body of any sports or
										teams in any countries
									</p>
								</div>
								<div className="col-lg-6">
						...
						<div className="container">
							<div className="inner-container text-center">
								<p className="site-footer__copy">
									&copy; copyright 2020 by <a href="#">Fanance.club</a>
								</p>
							</div>
						</div>
					</div>
